...
exec_cmd "$JPACKAGE_HOME/bin/jpackage --type $TYPE --vendor $VENDOR_STRING --icon src/main/resources/sudoku64x64.png --name $LAUNCHER $VERBOSE_OPTION --module-path $MODPATH --module $MAINMODULE/$MAINCLASS"
